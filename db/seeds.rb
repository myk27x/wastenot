...
User.create(email: 'stvin@example.com', password: 'depaul12')
...
User.create(email: 'womans@example.com', password: 'residence')
...
User.create(email: 'alpha@example.com', password: 'house123')
