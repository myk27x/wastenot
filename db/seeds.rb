...
User.create(name: 'Anonymous', email: 'noone@example.com', password_digest: 'sekret27')
...
User.create(name: 'Michael', email: 'michael@example.com', password_digest: 'reed1234')
...
User.create(name: 'Kristen', email: 'kristen@example.com', password_digest: 'swan1234')
...
User.create(name: 'St. Vincent', email: 'stvin@example.com', password_digest: 'depaul12')
...
User.create(name: 'Womans Residence', email: 'womans@example.com', password_digest: 'residence')
Receiver.create(user_id: 5, org_name: 'Womans Residence', street_address: '814 4th Ave N, St Petersburg, FL 33701', contact_name: 'Caring Lady', phone: '(727)555-1212', open:17, close:22, delivery_instructions: 'Bring all donations around back. Knock 3 times, 2 times, 3 times, and say the password_digest: Mellon. Someone will open the door slowly and greet you with: Welcome #wastenot...')

User.create(name: 'Alpha House', email: 'alpha@example.com', password_digest: 'house123')
